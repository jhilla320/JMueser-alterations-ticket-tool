...
export const DRIVE_FOLDER_ID = "1rk-sPX1XWoETrr_g4iwk13GoxYgDFLyx";
...
export const TICKET_STATUSES = ["Open", "In Progress", "Ready for Pickup", "Picked Up"];

// --- Form options ------------------------------------------------------
export const TAILORS = ["Luis", "Jesus", "Sam", "Other"];
export const SALESPEOPLE = [
  "Bodhi", "Chase", "Chris", "Christian", "Colin", "Edris",
  "Frank", "Jake", "Jeff", "Jonas", "Mattia", "Nor", "Ryder",
];
export const JACKET_SIZES = ["custom", "36", "38", "40", "42", "44", "46", "48"];
export const TROUSER_SIZES = ["custom", "28", "30", "32", "34", "36", "38"];
export const SHIRT_SIZES = ["custom", "15", "15.5", "15.75", "16", "16.5", "17", "17.5"];
