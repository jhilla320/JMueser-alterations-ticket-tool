      ...
      return `
        <section class="repeat-item" data-uid="${item._uid}">
          ...
          <div class="garment-field size-desc-row">
            ...
            <input id="sizeDescription-${item._uid}" type="text" placeholder="e.g. 40R Sportcoat" data-uid="${item._uid}" data-field="sizeDescription" value="${escapeHtml(item.sizeDescription)}" />
          </div>
          ${measurementBlock}
